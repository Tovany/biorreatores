Esse repositório tem como objetivo a modelagem matemática de um biorreator em batelada, obedecendo a cinética Andrews / Lee-Pirt-Coulman / Levenspiel, assim como a discussão dos resultados. 
...
<p align="justify">
A modelagem da cinética de crescimento do <i>Lactiplantibacillus plantarum</i> foi fundamentada no modelo estruturado (Equação 13) que associa simultaneamente os efeitos de inibição por excesso de substrato e saturação por produto.
</p>

<div align="center">
  <img src="./comparacao.jpeg" alt="comparação dos dados com simulação" width="800" height="500">
  <p>Figura 1</p>
</div>
